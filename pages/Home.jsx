                ...
                <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center pb-20">
                    ...
                    >
                        ...
                        <motion.p
                            ...
                            animate="visible"
                            custom={2}
                            className="text-[17px] md:text-xl text-slate-300 max-w-xl leading-relaxed font-light md:border-l-4 md:border-primary md:pl-6 px-2 md:px-0"
                        >
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-primary-light mb-12 font-light max-w-2xl mx-auto">
                            Ne vous contentez pas de la moyenne. Rejoignez les milliers de patients qui ont transformé leur vie avec le Dr. Ajina Manel.
                        </p>
